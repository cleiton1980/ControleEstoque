...
import br.com.ControleEstoque.controle.ControleClientes;
...
public class FrmClientes extends javax.swing.JFrame {
	...
	try {
	    ...
	    conex.rs.first();
	    cb_bairroCliente.removeAllItems();
	    do {
		cb_bairroCliente.addItem(conex.rs.getString("nome_bairro"));
	    } while (conex.rs.next());
	} catch (SQLException ex) {
	    JOptionPane.showMessageDialog(null, "Nenhum bairro esta Cadastrado");
	}
	conex.desconecta();
    }// FIM DO METODO
	...
	String[] colunas = new String[]{"Id", "Nome", "Endereço", "Nº", "Celular", "Telefone", "Bairro"};
	conex.Conexao();
	conex.executaSql(sql);
	try {
	    conex.rs.first();
	    do {
		dados.add(new Object[]{conex.rs.getInt("id_cliente"), conex.rs.getString("nome_cliente"), conex.rs.getString("endereco_cliente"), conex.rs.getString("numero_cliente"), conex.rs.getString("telefone1_cliente"), conex.rs.getString("telefone2_cliente"), conex.rs.getString("nome_bairro")});
	    } while (conex.rs.next());
	...
	tbl_clientes.getColumnModel().getColumn(0).setPreferredWidth(50);
	...
	tbl_clientes.getColumnModel().getColumn(2).setPreferredWidth(240);
	...
	tbl_clientes.getColumnModel().getColumn(4).setPreferredWidth(163);
	tbl_clientes.getColumnModel().getColumn(4).setResizable(false);

	tbl_clientes.getColumnModel().getColumn(5).setPreferredWidth(175);
	tbl_clientes.getColumnModel().getColumn(5).setResizable(false);

	tbl_clientes.getColumnModel().getColumn(6).setPreferredWidth(175);
    ...
    private void initComponents() {
        ...
        cb_bairroCliente = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("Formulário Cadastro de Clientes");
        ...
        lbl_idCliente.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lbl_idCliente.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_idCliente.setText("01");
        lbl_idCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(lbl_idCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(99, 99, 99)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(lbl_idCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jLabel2.setText("Digite uma Nome :");
        jLabel2.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        txt_nomeCliente.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txt_nomeCliente.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_nomeCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        cb_bairroCliente.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        cb_bairroCliente.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cb_bairroCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        cb_bairroCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                cb_bairroClienteMouseEntered(evt);
            }
        });
        ...
        txt_enderecoCliente.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txt_enderecoCliente.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_enderecoCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        txt_numeroCliente.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txt_numeroCliente.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_numeroCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        jLabel10.setText("Pesquise por um Cliente :");
        ...
        txt_cpfCliente.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        try {
        ...
        txt_cpfCliente.setToolTipText("");
        txt_cpfCliente.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(219, 219, 219)
                        .addComponent(txt_nomeCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(219, 219, 219)
                        .addComponent(cb_bairroCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(219, 219, 219)
                        .addComponent(txt_enderecoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(219, 219, 219)
                        .addComponent(txt_numeroCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cb_bairroCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel13)
                    .addComponent(txt_cpfCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txt_celular, txt_cpfCliente, txt_nomeCliente, txt_rgCliente, txt_telefoneCliente});
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Clientes Cadastrados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
	...
	if (pesquisa.equals("")) {
	    ...
	    txt_nomeCliente.setText(model.getNome_cliente());
	    txt_enderecoCliente.setText(model.getEndereco_cliente());
	    txt_numeroCliente.setText(model.getNumero_cliente());
	    ...
	    cb_bairroCliente.setSelectedItem(model.getNome_bairro());
    ...
    private void tbl_clientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_clientesMouseClicked
	  String nome_cliente = "" + tbl_clientes.getValueAt(tbl_clientes.getSelectedRow(), 1);
        ...
        try {
            conex.rs.first();
            lbl_idCliente.setText(Integer.toString(conex.rs.getInt("id_cliente")));
            txt_nomeCliente.setText(conex.rs.getString("nome_cliente"));
            txt_enderecoCliente.setText(conex.rs.getString("endereco_cliente"));
	    txt_numeroCliente.setText(conex.rs.getString("numero_cliente"));
            txt_rgCliente.setText(conex.rs.getString("rg_cliente"));
            txt_cpfCliente.setText(conex.rs.getString("cpf_cliente"));
            txt_celular.setText(conex.rs.getString("telefone1_cliente"));
            txt_telefoneCliente.setText(conex.rs.getString("telefone2_cliente"));
            cb_bairroCliente.setSelectedItem(conex.rs.getString("nome_bairro"));
        ...
        cb_bairroCliente.setEnabled(true);
        txt_enderecoCliente.setEnabled(true);
	txt_numeroCliente.setEnabled(true);
	...
	txt_enderecoCliente.setEnabled(false);
	txt_numeroCliente.setEnabled(false);
	...
	cb_bairroCliente.setEnabled(false);
	bt_salvar.setEnabled(false);
	bt_cancelar.setEnabled(true);
    ...
    private void cb_bairroClienteMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cb_bairroClienteMouseEntered

	try {
	    conex.Conexao();
	    conex.executaSql("select * from bairro inner join cidade on id_cidade = id_cidadef inner join estado on id_estadof=id_estado where nome_bairro = '" + cb_bairroCliente.getSelectedItem() + "'");
	    conex.rs.first();
	    txt_cidade.setText(conex.rs.getString("nome_cidade"));
	    txt_estado.setText(conex.rs.getString("nome_estado"));
	} catch (SQLException ex) {
    ...
    }//GEN-LAST:event_cb_bairroClienteMouseEntered
	...
	if (txt_nomeCliente.getText().isEmpty() || txt_enderecoCliente.getText().isEmpty()) {
	    JOptionPane.showMessageDialog(null, "há campos a serem preenchidos");
	} else {
	    mod.setNome_cliente(txt_nomeCliente.getText());
	    mod.setEndereco_cliente(txt_enderecoCliente.getText());
	    mod.setNumero_cliente(txt_numeroCliente.getText());
	    mod.setRg_cliente(txt_rgCliente.getText());
	    mod.setCpf_cliente(txt_cpfCliente.getText());
	    mod.setCelular_cliente(txt_celular.getText());
	    mod.setTelefone_cliente(txt_telefoneCliente.getText());
	    mod.setNome_bairro(cb_bairroCliente.getSelectedItem().toString());
	...
	mod.setId_cliente(Integer.parseInt(lbl_idCliente.getText()));
	mod.setNome_cliente(txt_nomeCliente.getText());
	mod.setEndereco_cliente(txt_enderecoCliente.getText());
	mod.setNumero_cliente(txt_numeroCliente.getText());
	mod.setRg_cliente(txt_rgCliente.getText());
    ...
    public javax.swing.JComboBox<String> cb_bairroCliente;
    ...
    public javax.swing.JFormattedTextField txt_cpfCliente;
    public javax.swing.JTextField txt_enderecoCliente;
    public javax.swing.JTextField txt_estado;
    public javax.swing.JTextField txt_nomeCliente;
    public javax.swing.JTextField txt_numeroCliente;
